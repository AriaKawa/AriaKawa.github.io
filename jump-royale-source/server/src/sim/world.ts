...
export const floodForMap=(map:string)=>map==='forest' ? {grace:6,base:30,acceleration:.08,max:52} : map==='magical' ? {grace:12,base:9,acceleration:.008,max:18} : map==='mountain'
