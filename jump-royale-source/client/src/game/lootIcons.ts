...
export function drawLootIcon(scene:Phaser.Scene,canvas:HTMLCanvasElement,item:LootEntry,frameIndex=0):void {
 ...
 if(item.slot==='animalHat'){drawAnimalHatIcon(scene,canvas,item.id);return;}
