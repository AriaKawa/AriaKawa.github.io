...
- **Deadroad 3 scenery atlas** — generated specifically for this rework with OpenAI built-in image generation on September 4, 2026. Sixteen original scenery objects in `client/public/assets/expedition-atlas.png`. Runtime framing preserves the alpha image; no third-party game artwork. See `docs/expedition-art-prompt.md` for the prompt.
