...
const sources={"demon-16":"exec-72a1dceb-aedb-43cf-82cb-d2d576bb9f08.png","demon-buns-16":"exec-484e2bb4-c9bf-48f0-b5b6-18efc5389f2a.png","demon-braid-16":"exec-9b4525d0-fed2-420c-b4ee-fc1183db95ce.png","neet-16":"exec-e8bd7def-bdc0-4262-9ef2-66f572b6a62c.png","cerberus-16":"exec-742b8b63-f4ce-48c5-9eef-9b9ecef2d766.png"};
...
await sharp({create:{width:1536,height:720,channels:4,background:'#304958'}}).composite(strips).png().toFile('docs/trio-16-frames.png');
