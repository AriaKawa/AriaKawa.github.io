...
export const FANTASY_CHARACTERS=['cerberus','magical-girl','skeleton'] as const;
export const FANTASY_SHEETS=['cerberus','magical-girl','magical-girl-buns','skeleton'] as const;
