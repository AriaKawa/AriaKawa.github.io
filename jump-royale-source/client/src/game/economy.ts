...
function lockedBase(o:Outfit):[string,string][] {
  if(['skeleton','magical-girl','neet','pogo','aria','pirate','astro-monkey','axolotl'].includes(o.character)){
  ...
  const animal=['puppy','cat','rat','cerberus','kangaroo'].includes(o.character);
