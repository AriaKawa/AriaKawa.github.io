...
import {DETAILED_CHARACTERS} from '../assets/detailedCostumes';
...
export const LOOT_POOL:LootEntry[]=[
 ...
 ...DETAILED_CHARACTERS.map(id=>({id:id+'-16',name:(COSMETICS.character.find(c=>c.id===id)?.name??id)+' · 16-bit',slot:'hdCostume',rarity:3})),
