...
const sceneChecks = [
  ...
  ["directional HRTF audio", /createPanner\(\)[\s\S]*panningModel="HRTF"[\s\S]*function updateSpatialListener/],
  ["legacy spatial audio fallback", /legacyListener\.setPosition[\s\S]*legacyListener\.setOrientation/],
