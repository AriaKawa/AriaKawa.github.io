...
- **OpenAI image generation — Missouri 3 road tile kit**, generated for this project on September 2, 2026. Six project-owned 512px base textures under `client/public/assets/generated/tilesets/missouri3/` provide straight, corner, diagonal, T-junction, crossroad, and dead-end roads; deterministic rotations supply every standard orientation. No external game artwork is embedded.
