...
export class GameClient {
  ...
  upgrade(towerId: string): void { this.local ? this.local.upgrade(towerId) : this.room?.send("upgrade", { towerId }); }
  ...
  deployConvoy(strategicOnLand?: boolean): void { this.local ? this.local.deployConvoy(strategicOnLand) : this.room?.send("deployConvoy", { strategicOnLand }); }
