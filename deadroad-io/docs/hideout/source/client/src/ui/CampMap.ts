...
const buildings = [
  ...
  { id: 'field', name: 'Field supplies', x: 314, y: 767, path: 'M67 546 L106 531 L155 508 L213 485 L254 466 L269 474 L310 492 L350 509 L397 532 L401 549 L435 536 L456 526 L479 543 L508 551 L542 560 L563 552 L572 556 L570 578 L562 583 L563 630 L585 639 L587 663 L574 680 L554 684 L550 698 L521 706 L491 695 L473 711 L454 718 L434 713 L420 723 L400 720 L383 710 L355 713 L327 727 L300 735 L283 726 L259 728 L236 712 L224 699 L201 706 L181 702 L158 688 L137 684 L123 670 L104 670 L95 651 L73 647 L62 630 L61 601 L70 592 Z' },
...
export function campMap(): string {
  return `<div class="camp-map camp-map-traced" aria-label="Base camp">
    ...
    <svg class="camp-interactions" viewBox="0 0 1536 1024" preserveAspectRatio="xMidYMid slice" aria-label="Choose a building">
    ...
    </svg><nav class="camp-mobile-nav" aria-label="Camp buildings">${buildings.map(b=>`<button data-tab="${b.id}">${b.name}</button>`).join('')}</nav>
  </div>`;
}
