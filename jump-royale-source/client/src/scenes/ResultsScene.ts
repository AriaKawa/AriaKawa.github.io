...
export class ResultsScene extends Phaser.Scene {
  ...
  create(data:{name:string;winner:string;placements:Placement[];localId:string;assisted?:boolean;goldEarned?:number;mapId?:MapId;leftEarly?:boolean}):void {
    ...
    const paths:Record<MapId,string>={magical:'menu/map-previews/magical.png',forest:'menu/map-previews/forest.png',forge:'reforged/backdrop.png',jungle:'jungle/background.png',snow:'snow/background.png',mountain:'jump-royale-ai/summit/background.webp'};
