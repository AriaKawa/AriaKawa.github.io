...
export const scraproadArenaLayouts: Record<ScraproadLevelId, ScraproadArenaLayout> = {
  dustring: {
    ...
    objective: "Run the circuit. Hit the ramps. Clear the targets.",
    surfaces: [
    ...
    targets: [
      { x: 42, z: -16, rotation: -quarter },
      { x: 45, z: -8, rotation: -quarter },
      { x: 46, z: 0, rotation: -quarter },
      { x: 45, z: 8, rotation: -quarter },
      { x: 42, z: 16, rotation: -quarter },
      { x: -7, z: 40, rotation: half },
    ],
    pickups: [
...
export const defaultScraproadLevel: ScraproadLevelId = "dustring";
